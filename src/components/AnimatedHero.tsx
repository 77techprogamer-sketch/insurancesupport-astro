      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-20">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-12">
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left lg:self-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.08] mb-6 text-white">
              Claim Rejection Recovery Experts
            </h1>

            <p className="text-lg text-blue-200/70 max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="/contact" className="group inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-400 to-amber-500 text-slate-900 font-bold rounded-full text-lg shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300">
                Request Free Case Assessment
                <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </a>
              <a href="tel:+919986634506" className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 border border-white/20 text-white font-semibold rounded-full hover:bg-white/20 backdrop-blur-sm transition-all">
         ...
         <div className="w-full lg:w-2/5 lg:self-center">
           <div className="relative">
             <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl gradient-border">
               <div className="text-center mb-6">
                 <div className="text-5xl font-extrabold text-amber-400 tracking-tight">₹50 Cr+</div>
